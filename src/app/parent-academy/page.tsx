  ...
  return (
    <main className="flex flex-col min-h-screen bg-background text-charcoal">
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: "easeOut" }}>
            ...
            <div className="flex flex-wrap gap-4">
              <CheckoutButton className="inline-flex items-center gap-2 bg-ink text-cream font-heading font-semibold px-8 py-3 rounded-lg hover:bg-charcoal transition-colors" />
              <a
                href="#modules"
      ...
      <section id="modules" className="max-w-3xl mx-auto w-full px-6 py-20">
        ...
        <p className="font-body text-text-body leading-relaxed text-center max-w-2xl mx-auto mb-12">
