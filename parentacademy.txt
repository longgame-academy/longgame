...
import { Car, Sparkles, Users, MessageCircle, Compass, Fuel, Target, Timer } from "lucide-react";
...
const whatYouGet = [
  ...
  { title: "Field Guides", body: "Twelve practical guides, one for every situation you'll face.", image: "/org-admin-phones.png" },
...
export default function ParentAcademyPage() {
  ...
  return (
    <main className="flex flex-col min-h-screen bg-background text-charcoal">
      ...
      <section className="max-w-6xl mx-auto w-full px-6 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
      ...
      {/* SECTION 5 REPEAT: PRICING BOX */}
      <section id="pricing" className="w-full px-6 py-16 md:py-20">
        <PricingCard />
        <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-1.5 text-[13px] font-body text-text-muted mt-6">
          <span className="flex items-center gap-1.5"><span className="text-teal">&#10003;</span> Secure Checkout</span>
          <span className="flex items-center gap-1.5"><span className="text-teal">&#10003;</span> Instant Access</span>
      ...
      <section className="bg-background py-10 md:py-12">
        <div className="max-w-4xl mx-auto px-6 flex flex-col md:flex-row gap-8 md:gap-14 items-center">
          ...
          <div className="md:border-l border-border-grey md:pl-14 text-center md:text-left">
